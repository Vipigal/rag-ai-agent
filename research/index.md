...
- [Case Files Corpus Findings](case-files-corpus-findings.md) - Empirical survey of the four case_files PDFs — languages, structure, extraction quality — including the CESTARI fonts that lack a ToUnicode map (glyph ids intact in Arial's standard order, repairable without OCR) and measured pymupdf4llm 1.28.2 behavior on this corpus.
