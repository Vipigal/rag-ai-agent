...
description: The specification of the documentation format this repo's knowledge bundle is written in. Spec text is verbatim; only this frontmatter block is local.
